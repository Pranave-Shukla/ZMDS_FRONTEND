...
var ProductApi = /** @class */ (function (_super) {
     ...
     * Product details
     */
    ProductApi.prototype.getProductDetailsRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.ProductDetailsResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Product details
     */
    ProductApi.prototype.getProductDetails = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getProductDetailsRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
     ...
     * Products list
     */
    ProductApi.prototype.getProductsRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: models_1.ProductsRequestToJSON(requestParameters.productsRequest),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.ProductsResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Products list
     */
    ProductApi.prototype.getProducts = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getProductsRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    ProductApi.prototype.updateProductRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: models_1.ProductPartialRequestToJSON(requestParameters.productPartialRequest),
                            })];
                    case 1:
                        response = _a.sent();
     ...
     * Product details update
     */
    ProductApi.prototype.updateProduct = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.updateProductRaw(requestParameters)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
