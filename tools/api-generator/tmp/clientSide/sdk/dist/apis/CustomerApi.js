...
var CustomerApi = /** @class */ (function (_super) {
     ...
     * Customer details
     */
    CustomerApi.prototype.getCustomerDetailsRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.CustomerDetailsResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Customer details
     */
    CustomerApi.prototype.getCustomerDetails = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getCustomerDetailsRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: models_1.CustomersRequestToJSON(requestParameters.customersRequest),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.CustomersResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Customers list
     */
    CustomerApi.prototype.getCustomers = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getCustomersRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    CustomerApi.prototype.updateCustomerRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: models_1.CustomerPartialRequestToJSON(requestParameters.customerPartialRequest),
                            })];
                    case 1:
                        response = _a.sent();
     ...
     * Customer details update
     */
    CustomerApi.prototype.updateCustomer = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.updateCustomerRaw(requestParameters)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
